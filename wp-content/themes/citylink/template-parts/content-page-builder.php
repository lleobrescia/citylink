        ...
        <div class="row">
          <div class="col-sm-7 col-md-8">
            <div class="welcome_text_area">
              <h2><?php the_sub_field('bem-vindo_titulo');?></h2>
              <p><?php the_sub_field('bem-vindo_subtitulo');?></p>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="section_heading wow fadeInUp">
          <h2><?php the_sub_field('titulo_feature');?></h2>
          <p><?php the_sub_field('features_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
      <!--col-xs-12-->
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="single_about_part wow fadeInUp" data-wow-delay="0.2s">
                ...
                <h3><?php the_sub_field('feature_titulo');?></h3>
                <p><?php the_sub_field('feature_texto');?></p>
              </div>
            </div>
            <!--col-xs-12-->
              <?php endwhile; ?>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="video_area_text text-center section_padding_100">
              <h2><?php the_sub_field('video_titulo');?></h2>
              <p><?php the_sub_field('video_subtitulo');?></p>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-5">
        ...
        <div class="about_us_text_area">
          <h3><?php the_sub_field('sobre_titulo');?></h3>
              <?php the_sub_field('sobre_conteudo');?>
          <a href="<?php the_sub_field('sobre_link');?>"><?php the_sub_field('sobre_botao');?></a>
        </div>
        <!--about_us_text_area-->
      </div>
      <!--col-sm-6 col-md-5-->
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <!-- Section Heading Start -->
        <div class="section_heading wow fadeInUp">
          <h2><?php the_sub_field('beneficios_titulo');?></h2>
          <p><?php the_sub_field('beneficios_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
      <!--col-xs-12-->
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <!-- Section Heading Start -->
        <div class="section_heading wow fadeInUp">
          <h2><?php the_sub_field('funciona_titulo');?></h2>
          <p><?php the_sub_field('funciona_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
      <!--col-xs-12-->
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-3">
        <div class="single_work_step wow fadeInUp" data-wow-delay="0.2s">
          ...
          <h4><?php the_sub_field('passo_titulo');?></h4>
          <p><?php the_sub_field('passo_texto');?></p>
        </div>
        <!--single_work_step-->
      </div>
      <!--col-sm-6 col-md-3-->
            ...
            <div class="single_testimonial_area text-center">
              ...
              <div class="testimonial_text">
                ...
                <div class="testimonial_author_name">
                  <h4><?php the_sub_field('depoimento_nome');?></h4>
                  <h5><?php the_sub_field('depoimento_titulo');?></h5>
                </div>
              </div>
            </div>
              <?php endwhile; ?>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="section_heading wow fadeInUp">
          ...
          <p><?php the_sub_field('slide_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
      <!--col-xs-12-->
    ...
    <?php if( get_row_layout('preco_box') ): ?>
      ...
      <div class="col-sm-6 col-md-3">
        <div class="single_price_plan item wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="button">
            <a class="btn btn-default" href="<?php the_sub_field('preco_link');?>" role="button"><?php the_sub_field('preco_botao');?></a>
          </div>
        </div>
      </div>
      <!--col-sm-6 col-md-3-->
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="section_heading wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
          <h2><?php the_sub_field('texto_titulo');?></h2>
          <p><?php the_sub_field('text_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
      <!--col-xs-12-->
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <!-- Section Heading Start -->
        <div class="section_heading wow fadeInUp">
          <h2><?php the_sub_field('faq_titulo');?></h2>
          <p><?php the_sub_field('faq_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
    </div>
      ...
      <div class="col-xs-12 clearfix">
        <div class="accordions" id="accordion2" role="tablist" aria-multiselectable="true">
          ...
          <div class="panel single-accordion">
            <h5>
              <a role="button" class="collapsed" aria-expanded="true" aria-controls="six<?php echo $count; ?>" data-toggle="collapse" data-parent="#accordion2" href="#six<?php echo $count; ?>">
            ...
            <div id="six<?php echo $count; ?>" class="accordion-content collapse">
              <p><?php the_sub_field('faq_resposta');?></p>
            </div>
          </div>
            <?php $count++; ?>
            <?php endwhile; ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <!-- Section Heading Start -->
        <div class="section_heading wow fadeInUp">
          <h2><?php the_sub_field('histo_titulo');?></h2>
          <p><?php the_sub_field('histo_subtitulo');?></p>
        </div>
        <!-- Section Heading End -->
      </div>
      <!--col-xs-12-->
        ...
        <?php $lado = 'even-item'; ?>
          ...
          <div class="single_timeline_block <?php echo $lado; ?> clearfix wow fadeInUp">
            ...
            <div class="timeline_text_content">
              <h3><?php the_sub_field('evento_titulo');?></h3>
              <h5><?php the_sub_field('evento_data');?></h5>
              <p><?php the_sub_field('evento_descricao');?></p>
            </div>
...
<!--timeline_area-->
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <p><?php esc_html_e( 'It looks like nothing was found at this location.', 'citylink' ); ?></p>
      </div>
    </div>
  </div>
<?php endif;?>